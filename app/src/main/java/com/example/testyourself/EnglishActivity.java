...
public class EnglishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EnglishDatabase dbHelper = new EnglishDatabase(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()||rb2.isChecked()||rb3.isChecked()||rb4.isChecked()){
                        ...
                        Toast.makeText(EnglishActivity.this, "please, Select an answer!", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    showNextQuestion();
    ...
    private void finishTest(){
        ...
        Intent int_end = new Intent(EnglishActivity.this, EndActivity.class);

        int_end.putExtra("score", score);
        int_end.putExtra("total", "/30");
