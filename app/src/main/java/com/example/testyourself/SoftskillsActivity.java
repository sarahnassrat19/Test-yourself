...
public class SoftskillsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SoftskillsDatabase dbHelper = new SoftskillsDatabase(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()||rb2.isChecked()||rb3.isChecked()||rb4.isChecked()){
                        ...
                        Toast.makeText(SoftskillsActivity.this, "please, Select an answer!", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    showNextQuestion();
    ...
    private void finishTest(){
        ...
        Intent int_end = new Intent(SoftskillsActivity.this, EndActivity.class);
