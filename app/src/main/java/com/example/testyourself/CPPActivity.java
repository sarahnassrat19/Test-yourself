...
public class CPPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CPPDatabase dbHelper = new CPPDatabase(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()||rb2.isChecked()||rb3.isChecked()||rb4.isChecked()){
                        ...
                        Toast.makeText(CPPActivity.this, "please, Select an answer!", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    showNextQuestion();
    ...
    private void finishTest(){
        ...
        Intent int_end = new Intent(CPPActivity.this, EndActivity.class);

        int_end.putExtra("score", score);
        int_end.putExtra("total", "/20");
